...
export default function OrphanateDetails() {
  ...
  function handleGoogleMapsRoute() {
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${orphanate?.latitude},${orphanate?.longitude}`);
  }
  if (!orphanate) {
    return (
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.title}>{orphanate.name}</Text>
        <Text style={styles.description}>{orphanate.about}</Text>
        ...
        <Text style={styles.description}>{orphanate.intructions}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>{orphanate.opening_hours}</Text>
          </View>
